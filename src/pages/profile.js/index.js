...
function Profile() {
    ...
    const settingsToggle = () => setDisplaySettings(prevSettings => !prevSettings);
		...
		<div className='container'>
			...
			<div className='bio'>
				...
				{location.state.isAvatarImageSet && (
					<img src={selectedAvatar || location.state.avatarImage}  alt='current avatar' />
				)}

                <button onClick={settingsToggle}>Change Avatar</button>
			</div>

            { displaySettings && <div className='settings'>
